    ...
    return (
        <div className="p-4 min-h-screen max-w-2xl mx-auto bg-white">
            ...
            <div className="text-center mb-8">
                ...
                <p className="text-sky-600 font-medium mt-1">Successful</p>
            </div>
            ...
            <div className="mb-8 overflow-x-auto">
                <div className="flex items-center justify-between min-w-[320px] sm:min-w-0">
                    ...
                    {/* Connector */}
                    <div className="flex-1 h-1 bg-sky-600 mx-2" />
                ...
                <div className="flex justify-center p-3 rounded-lg bg-sky-600 w-60 mt-12">
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow space-y-4">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-y-2">
                    ...
                    <p className="font-semibold text-gray-800 dark:text-white">202509068225004</p>
                </div>
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-y-2">
                    <span className="text-gray-600 dark:text-gray-400">Transaction Date</span>
                    <p className="font-semibold text-gray-800 dark:text-white">Sept 6th, 2025 17:01:25</p>
                </div>
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-y-2">
                    <span className="text-gray-600 dark:text-gray-400">Session ID</span>
                    <p className="font-semibold text-gray-800 dark:text-white">
                        400002015683240197552834610927
                    </p>
                </div>
            </div>

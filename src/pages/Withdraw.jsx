...
const withdrawOptions = [
  ...
  { name: "CashApp", icon: <FaCashRegister className="text-sky-500 text-3xl" /> },
  { name: "Zelle", icon: <FaUniversity className="text-sky-600 text-3xl" /> },
  { name: "Venmo", icon: <FaGooglePay className="text-blue-500 text-3xl" /> },
  { name: "Chime", icon: <FaMoneyCheckAlt className="text-sky-500 text-3xl" /> },
];
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {cardTypes.map((type) => (
                          <button
                            ...
                            className="bg-gradient-to-br from-sky-500 to-sky-700 text-white py-2 rounded-lg font-semibold hover:from-sky-600 hover:to-sky-800 transition"
                          >
                            {type}
                          </button>
                        ))}
                  ...
                  {["CashApp", "Zelle", "Venmo", "Chime"].includes(item.name) && (
                    <div className="mt-3 text-center">
                      <button
                        ...
                        className="px-5 py-2 bg-gradient-to-r from-sky-500 to-sky-600 text-white rounded-lg hover:from-sky-600 hover:to-sky-700 transition"
                      >
